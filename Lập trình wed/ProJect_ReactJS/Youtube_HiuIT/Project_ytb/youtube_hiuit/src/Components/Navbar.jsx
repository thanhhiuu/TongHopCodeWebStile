      ...
      <Container>
        <Wrapper>
          ...
          <Wrapper>
            ...
            {currentUser ? (
              <User >
                {lognOut && <VideoCallIcon onClick={() => setOpen(!open)} />}
                {lognOut && <Avatar src={currentUser.imgUlr} />}
                {lognOut && currentUser.username}
                <LognOut className='btn btn-danger' onClick={handlLognOut}>{lognOut ? "Đăng xuất" : "Đăng nhập"}</LognOut>
              </User>
